...
export default function NotificationsPopover({ workspaceId, currentUser }) {
    ...
    useEffect(() => {
        if (workspaceId) {
            ...
            // Realtime subscription for incoming activity
                        ...
                        {displayedNotifications.length === 0 ? (
                            ...
                            displayedNotifications.map((item) => (
                                <div
                                    ...
                                    className={`p-3.5 hover:bg-slate-50 transition cursor-pointer flex items-start gap-3 text-xs ${!item.read ? 'bg-blue-50/30' : ''
                                        }`}
                                >
                                    ...
                                    <div className="flex-1 min-w-0">
                                        <div className="flex items-center justify-between gap-2">
                                            <p className="font-bold text-slate-900 truncate">
                                                {item.title || item.sender_name || 'System Update'}
                                            </p>
                                            {!item.read && (
                                        ...
                                        <p className="text-slate-600 text-[11px] line-clamp-2 mt-0.5 leading-relaxed">
                                            {item.content || item.message || 'Updated workspace item'}
                                        </p>
